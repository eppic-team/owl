 ...
 * @author stehr
 */
public class PhosphoSiteConnection {
	...
	public static final String UNIPROT_ACC_URL="http://www.phosphosite.org/uniprotAccAction.do?id=P16234";
	...
	public static void main(String[] args) {
		...
		String protId = "P01111";
		File htmlFile = new File(phophoSiteDir, protId + ".html");

		Collection<PhosphoSitePlusFeature> sites = PhosphoSiteConnection.getModifications(htmlFile);
		if(sites.size() == 0) {
			System.err.println("No modification sites founds");
		} else {
			System.out.println("Modification sites in " + protId + ":");
