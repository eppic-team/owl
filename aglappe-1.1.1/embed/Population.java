...
public class Population {
	 ...
	 * @param p
	 */
	public Population (Individuals[] p){
		this.setPop(p);
	 ...
	 * @param pop
	 */
	public static void bestFifty (boolean CMDM, Population pop){
		int dim = pop.getSize();
		double[] error = new double[dim];
		double errorval = 0.0;
		double stmd = 0.0;
	 ...
	 * @throws PdbLoadError
	 */
	public static Individuals[] evolve (boolean CMDM, Population pop) throws SQLException, PdbCodeNotFoundError, PdbLoadError {
