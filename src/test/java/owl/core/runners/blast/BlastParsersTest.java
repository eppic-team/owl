...
public class BlastParsersTest {
	...
	private static final String CASP7_TARGETS_DIR = "/owl/core/structure/casp7/";
	...
	public void setUp() throws Exception {
		...
		for (String target: testSetCasp7) {
			File queryFile = TestsSetup.inputStreamToTempFile(
						BlastParsersTest.class.getResourceAsStream(CASP7_TARGETS_DIR+target+".fa"), 
						target, ".fa");
