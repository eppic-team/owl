 ...
 * 
 * Changelog:
 * 2007/12/20 first created by HS
 * 2008/02/21 added CMVIEW header for OWL_CM_FILE
 * 2010/03/31 moved to package owl.core.util
 * 2011/03/03 added CRYST1 and SEQRES headers for PDB_FILE (JD)
 */
