...
public class ContactMap {
	...
	public ContactMap (String pdb_code, int max_pot) throws SQLException, PdbCodeNotFoundError, PdbLoadError{
		contact_coverage = 0.1;
		max_potence = max_pot;
		setContactMap(pdb_code);
	}
	
	public ContactMap (String pdb_code, int max_pot, double contact) throws SQLException, PdbCodeNotFoundError, PdbLoadError, ContactMatrixException{
	...
	public ContactMap (int max_pot, String path) throws IOException, SQLException, PdbCodeNotFoundError, PdbLoadError{
		setContactMap(max_pot,path,0.1);
	}
	
	public ContactMap (int max_pot, String path, double contact) throws IOException, SQLException, PdbCodeNotFoundError, PdbLoadError{
	...
	public void setContactMap (int max_pot, String path, double contact) throws IOException, SQLException, PdbCodeNotFoundError, PdbLoadError, ContactMatrixException {
		if(contact > 0.0 && contact < 1.0) contact_coverage = contact;
		else throw new ContactMatrixException("Parameter 'contact' must be element in the open unit intervall, but was set to :"+contact+"!");
		max_potence = max_pot;
	...
	public Individuals convertToIndividuals (SparseMatrix mat) throws SQLException, PdbCodeNotFoundError, PdbLoadError{
