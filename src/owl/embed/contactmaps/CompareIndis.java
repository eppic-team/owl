...
public class CompareIndis extends Demes {
	...
	public CompareIndis (String dir) throws SQLException, PdbCodeNotFoundException, PdbLoadException, FileNotFoundException, IOException{
		super();
	...
	public void generateIndis () throws PdbCodeNotFoundException, SQLException, PdbLoadException{
