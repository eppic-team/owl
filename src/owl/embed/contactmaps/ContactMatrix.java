...
public class ContactMatrix extends owl.core.structure.RIGraph {
	...
	public ContactMatrix (String pdb_code) throws SQLException, PdbCodeNotFoundError, PdbLoadError{
		super();
		setFields(pdb_code);
	}
	
	public void setFields (String pdb_code) throws SQLException, PdbCodeNotFoundError, PdbLoadError{
