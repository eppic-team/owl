...
public class cnHashIterNbhood {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("CN Size Hashed Iterating / Evaluating neighborhood v.0.3. "); 
...
//					clear first 
					...
					System.out.println("Scoring ["+i+"]["+j+"] (-"+ixnum+"/+"+jxnum+")\t"+newnbs[i][j]);
